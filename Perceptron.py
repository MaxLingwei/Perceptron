...
if __name__ == '__main__':
	...
	train_perceptron(weight_set[0], 0.2, train_set_1)
	train_perceptron(weight_set[1], 0.2, train_set_2)
	train_perceptron(weight_set[2], 0.2, train_set_3)

	print "result"
	for i in range(0, weight_set):
		print weight_set[i]
